<html>
    ...
    <body style="font-family: 'Comfortaa';">
        <div class="container" style="width:660px;height:850px;margin:auto;text-align: center;position:relative;">
            ...
            <span style="position: relative; z-index: 2;display: inline-block; margin-top: 63px;font-size: 30px;color:white;width:500px;height:66px;background-color: rgba(255,255,255,.3);line-height: 66px;box-shadow: 0px 0px 37px -12px rgba(0,0,0,0.75);"><?php echo __('email_address_confirmation');?></span><br />
            <span style="position: relative; z-index: 2;display: inline-block;margin-top:80px;background-color:white;width: 400px;padding:40px 50px 10px 50px;line-height:200%;font-size: 18px;height:182px;"><?php echo __('email_address_confirmation_2');?></span><br />
            <a href="http://localhost/wallency/Vendor/cakephp/cakephp/activate?uuid=<?=$uuid?>" style="position: relative; z-index: 2;display: inline-block;background-color:#00669C;width: 480px;padding:10px;font-size: 12px;height:30px;line-height:30px;color:white;font-size:20px;text-decoration:none;cursor:pointer;"><?php echo __("address_confirmation_btn");?></a><br />
