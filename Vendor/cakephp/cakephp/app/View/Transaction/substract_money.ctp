...
<div class="main">
    ...
    <input type="hidden" id="link" value="http://localhost/wallency/Vendor/cakephp/cakephp/wallet?amountSold=<?=$amountSold?>&currencySold=<?=$currencySold?>&showModal=true&type=withdraw"/>
</div>
