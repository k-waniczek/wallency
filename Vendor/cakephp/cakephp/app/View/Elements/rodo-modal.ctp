<div class="rodoModal">
    ...
    <span>We may process your data, which may constitute personal data (in particular: IP address, browser and operating system data, and approximate location):
    ...
    You have the right to access data concerning you, request their rectification, deletion or limitation of processing, object to the processing, transfer them, as well as to a complaint to the President of the Office for Personal Data Protection in Poland or its equivalent in another EU country.</span>
    <h3>Cookies</h3>
    <span>The site may use cookies and other similar technologies for the purposes listed above. Consent to their use is expressed through the settings selected in your browser.</span>
    <h3>Consent to profiling</h3>
    <span>Your data mentioned above may be subject to profiling to assess some of your personal characteristics in order to better tailor commercial information to you as part of direct marketing of services and products, in particular related to vehicles, if you agree to this by clicking below "I accept", until it is withdrawn . You can withdraw your consent at any time by informing us by email to the address above or in the account settings, if you have one, without affecting the lawfulness of the processing based on consent before its withdrawal.
    More information in our privacy policy.</span>
    <div class="buttons">
        <button id="accept">
            Accept
        </button>
